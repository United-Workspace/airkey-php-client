...
# **getLockProtocol**
> \Evva\AirKey\Model\LockProtocolPagingList getLockProtocol($offset, $limit, $area_id, $lock_id, $from, $to, $language)
...
$apiInstance = new Evva\AirKey\Api\LockProtocolApi(
...
[**\Evva\AirKey\Model\LockProtocolPagingList**](../Model/LockProtocolPagingList.md)
...
> \Evva\AirKey\Model\LockProtocolPagingList getLockProtocolLimited($offset, $limit, $area_id, $lock_id, $from, $to, $language)
