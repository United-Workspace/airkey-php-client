...
$body = new \Evva\AirKey\Model\SendAKeyRequest(); // \Evva\AirKey\Model\SendAKeyRequest | Send-A-Key request wrapper
...
------------- | ------------- | ------------- | -------------
 **body** | [**\Evva\AirKey\Model\SendAKeyRequest**](../Model/SendAKeyRequest.md)| Send-A-Key request wrapper |
