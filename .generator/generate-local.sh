...
echo "========================================"
echo "    Local AirKey API Client Generator   "
echo "========================================"
...
cp -R php-client/lib/. lib/ 2>/dev/null || true
cp -R php-client/docs/. docs/ 2>/dev/null || true
cp -R php-client/test/. test/ 2>/dev/null || true
rm -rf php-client
