...
class SystemProtocolApi
{
     ...
     * @return \Evva\AirKey\Model\SystemProtocolPagingList
     */
     ...
     * @throws \Evva\AirKey\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Evva\AirKey\Model\SystemProtocolPagingList, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $returnType = '\Evva\AirKey\Model\SystemProtocolPagingList';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Evva\AirKey\Model\SystemProtocolPagingList',
