...
use Evva\AirKey\HeaderSelector;
...
class MediaApi
{
     ...
     *
     * @throws \Evva\AirKey\ApiException on non-2xx response
     ...
     *
     * @param  \Evva\AirKey\Model\MediumAssignment[] $body List of medium assignments (required)
     *
     * @throws \Evva\AirKey\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Evva\AirKey\Model\MediumAssignment[]
     */
     ...
     * @throws \Evva\AirKey\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Evva\AirKey\Model\MediumAssignment[], HTTP status code, HTTP response headers (array of strings)
     */
    public function assignOwnerToMediumWithHttpInfo($body)
    {
        $returnType = '\Evva\AirKey\Model\MediumAssignment[]';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Evva\AirKey\Model\MediumAssignment[]',
     ...
     *
     * @param  \Evva\AirKey\Model\PhoneCreate[] $body List of phones to be added (required)
     *
     * @throws \Evva\AirKey\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Evva\AirKey\Model\Phone[]
     */
     ...
     * @throws \Evva\AirKey\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Evva\AirKey\Model\Phone[], HTTP status code, HTTP response headers (array of strings)
     */
    public function createPhonesWithHttpInfo($body)
    {
        $returnType = '\Evva\AirKey\Model\Phone[]';
     ...
     * @throws \Evva\AirKey\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Evva\AirKey\Model\Medium
     */
     ...
     * @throws \Evva\AirKey\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Evva\AirKey\Model\Medium, HTTP status code, HTTP response headers (array of strings)
     */
    public function deactivateMediumWithHttpInfo($medium_id, $reason, $comment = null)
    {
        $returnType = '\Evva\AirKey\Model\Medium';
     ...
     * @throws \Evva\AirKey\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Evva\AirKey\Model\Card, HTTP status code, HTTP response headers (array of strings)
     */
    public function getCardWithHttpInfo($card_id)
    {
        $returnType = '\Evva\AirKey\Model\Card';
     ...
     * @throws \Evva\AirKey\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Evva\AirKey\Model\CardPagingList
     */
     ...
     * @throws \Evva\AirKey\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Evva\AirKey\Model\CardPagingList, HTTP status code, HTTP response headers (array of strings)
     */
    public function getCardsWithHttpInfo($person_id = null, $locking_system_id = null, $assignment_status = null, $offset = null, $limit = null)
    {
        $returnType = '\Evva\AirKey\Model\CardPagingList';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Evva\AirKey\Model\CardPagingList',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \Evva\AirKey\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Evva\AirKey\Model\MediumPagingList
     */
     ...
     * @throws \Evva\AirKey\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Evva\AirKey\Model\MediumPagingList, HTTP status code, HTTP response headers (array of strings)
     */
    public function getMediaWithHttpInfo($person_id = null, $locking_system_id = null, $assignment_status = null, $offset = null, $limit = null)
    {
        $returnType = '\Evva\AirKey\Model\MediumPagingList';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Evva\AirKey\Model\MediumPagingList',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \Evva\AirKey\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Evva\AirKey\Model\PendingPhoneReplacementListDto
     */
     ...
     * @throws \Evva\AirKey\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Evva\AirKey\Model\PendingPhoneReplacementListDto, HTTP status code, HTTP response headers (array of strings)
     */
    public function getPendingPhoneReplacementsWithHttpInfo()
    {
        $returnType = '\Evva\AirKey\Model\PendingPhoneReplacementListDto';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Evva\AirKey\Model\PendingPhoneReplacementListDto',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \Evva\AirKey\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Evva\AirKey\Model\PhonePagingList
     */
     ...
     * @throws \Evva\AirKey\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Evva\AirKey\Model\PhonePagingList, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $returnType = '\Evva\AirKey\Model\PhonePagingList';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Evva\AirKey\Model\PhonePagingList',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  int $phone_id Unique identifier of the phone (required)
     * @param  \Evva\AirKey\Model\SendRegistrationCodeSmsRequest $body Send registration code request wrapper (optional)
     *
     * @throws \Evva\AirKey\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Evva\AirKey\Model\Phone
     ...
     *
     * @param  int $phone_id Unique identifier of the phone (required)
     * @param  \Evva\AirKey\Model\SendRegistrationCodeMailRequest $body Send registration code via email request wrapper (required)
     *
     * @throws \Evva\AirKey\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Evva\AirKey\Model\Phone
     ...
     *
     * @param  int $phone_id Unique identifier of the phone (required)
     * @param  \Evva\AirKey\Model\SendRegistrationCodeSmsRequest $body Send registration code request wrapper (required)
     *
     * @throws \Evva\AirKey\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Evva\AirKey\Model\Phone
     ...
     *
     * @param  \Evva\AirKey\Model\Card[] $body List of cards to be updated (required)
     *
     * @throws \Evva\AirKey\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Evva\AirKey\Model\Card[]
     ...
     *
     * @param  \Evva\AirKey\Model\Phone[] $body List of phones to be updated (required)
     *
     * @throws \Evva\AirKey\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Evva\AirKey\Model\Phone[]
