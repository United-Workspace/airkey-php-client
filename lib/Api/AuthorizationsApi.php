...
class AuthorizationsApi
{
     ...
     *
     * @param  \Evva\AirKey\Model\SimpleAuthorizationCreate $body Authorization to be created (required)
     *
     * @throws \Evva\AirKey\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Evva\AirKey\Model\Authorization
     */
     ...
     * @throws \Evva\AirKey\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Evva\AirKey\Model\Authorization, HTTP status code, HTTP response headers (array of strings)
     */
    public function createOrFetchSimpleAuthorizationWithHttpInfo($body)
    {
        $returnType = '\Evva\AirKey\Model\Authorization';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Evva\AirKey\Model\Authorization',
     ...
     *
     * @param  \Evva\AirKey\Model\AuthorizationChange $body Authorizations to be created or updated (required)
     *
     * @throws \Evva\AirKey\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Evva\AirKey\Model\Authorization[]
     ...
     *
     * @param  \Evva\AirKey\Model\AuthorizationDelete[] $body Authorizations to be deleted (required)
     *
     * @throws \Evva\AirKey\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Evva\AirKey\Model\Authorization[]
     ...
     * @throws \Evva\AirKey\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Evva\AirKey\Model\AuthorizationPagingList
     */
     ...
     * @throws \Evva\AirKey\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Evva\AirKey\Model\AuthorizationPagingList, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $returnType = '\Evva\AirKey\Model\AuthorizationPagingList';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Evva\AirKey\Model\AuthorizationPagingList',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
