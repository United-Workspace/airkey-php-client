...
class AreasApi
{
     ...
     * @throws \Evva\AirKey\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Evva\AirKey\Model\Area, HTTP status code, HTTP response headers (array of strings)
     */
    public function getAreaWithHttpInfo($area_id)
    {
        $returnType = '\Evva\AirKey\Model\Area';
     ...
     * @throws \Evva\AirKey\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Evva\AirKey\Model\AreaPagingList
     */
     ...
     * @throws \Evva\AirKey\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Evva\AirKey\Model\AreaPagingList, HTTP status code, HTTP response headers (array of strings)
     */
    public function getAreasWithHttpInfo($lock_id = null, $offset = null, $limit = null)
    {
        $returnType = '\Evva\AirKey\Model\AreaPagingList';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Evva\AirKey\Model\AreaPagingList',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
