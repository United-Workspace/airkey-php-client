...
class LocksApi
{
     ...
     *
     * @param  \Evva\AirKey\Model\SharedLock $body Data to redeem sharing code (required)
     *
     * @throws \Evva\AirKey\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Evva\AirKey\Model\Lock
     */
     ...
     * @throws \Evva\AirKey\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Evva\AirKey\Model\Lock, HTTP status code, HTTP response headers (array of strings)
     */
    public function addSharedLockWithHttpInfo($body)
    {
        $returnType = '\Evva\AirKey\Model\Lock';
     ...
     * @throws \Evva\AirKey\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Evva\AirKey\Model\AssignedArea[]
     */
     ...
     * @throws \Evva\AirKey\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Evva\AirKey\Model\AssignedArea[], HTTP status code, HTTP response headers (array of strings)
     */
    public function assignAreasWithHttpInfo($lock_id, $body)
    {
        $returnType = '\Evva\AirKey\Model\AssignedArea[]';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Evva\AirKey\Model\AssignedArea[]',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \Evva\AirKey\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Evva\AirKey\Model\SharingCode
     */
     ...
     * @throws \Evva\AirKey\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Evva\AirKey\Model\SharingCode, HTTP status code, HTTP response headers (array of strings)
     */
    public function createSharingCodeWithHttpInfo($lock_id)
    {
        $returnType = '\Evva\AirKey\Model\SharingCode';
     ...
     * @throws \Evva\AirKey\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Evva\AirKey\Model\ActiveShare[]
     */
     ...
     * @throws \Evva\AirKey\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Evva\AirKey\Model\ActiveShare[], HTTP status code, HTTP response headers (array of strings)
     */
    public function getActiveSharesWithHttpInfo($lock_id)
    {
        $returnType = '\Evva\AirKey\Model\ActiveShare[]';
     ...
     * @throws \Evva\AirKey\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Evva\AirKey\Model\LockSettings
     */
     ...
     * @throws \Evva\AirKey\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Evva\AirKey\Model\LockSettings, HTTP status code, HTTP response headers (array of strings)
     */
    public function getLockSettingsWithHttpInfo($lock_id)
    {
        $returnType = '\Evva\AirKey\Model\LockSettings';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Evva\AirKey\Model\LockSettings',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \Evva\AirKey\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Evva\AirKey\Model\LockPagingList
     */
     ...
     * @throws \Evva\AirKey\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Evva\AirKey\Model\LockPagingList, HTTP status code, HTTP response headers (array of strings)
     */
    public function getLocksWithHttpInfo($offset = null, $limit = null, $calendar_id = null, $locking_system_id = null)
    {
        $returnType = '\Evva\AirKey\Model\LockPagingList';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Evva\AirKey\Model\LockPagingList',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  int $lock_id Unique identifier of the lock (required)
     * @param  \Evva\AirKey\Model\Lock $body Lock to be updated (required)
     *
     * @throws \Evva\AirKey\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Evva\AirKey\Model\Lock
     ...
     *
     * @param  int $lock_id Unique identifier of the lock (required)
     * @param  \Evva\AirKey\Model\LockSettings $body Lock settings to be updated (required)
     *
     * @throws \Evva\AirKey\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Evva\AirKey\Model\LockSettings
