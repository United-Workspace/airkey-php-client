...
class SendAKeyApi
{
     ...
     *
     * @param  \Evva\AirKey\Model\SendAKeySmsRequest $body Send-A-Key via SMS request wrapper (required)
     *
     * @throws \Evva\AirKey\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Evva\AirKey\Model\SendAKeyResponse
     */
     ...
     * @throws \Evva\AirKey\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Evva\AirKey\Model\SendAKeyResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function sendAKeyWithHttpInfo($body)
    {
        $returnType = '\Evva\AirKey\Model\SendAKeyResponse';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Evva\AirKey\Model\SendAKeyResponse',
     ...
     *
     * @param  \Evva\AirKey\Model\SendAKeyMailRequest $body Send-A-Key via email request wrapper (required)
     *
     * @throws \Evva\AirKey\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Evva\AirKey\Model\SendAKeyResponse
