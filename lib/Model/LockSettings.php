...
class LockSettings implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'anonymize_event_log' => '\Evva\AirKey\Model\AnonymizeEventLog',
        'anonymize_data_in_owner_protocol' => 'bool',
        'office_mode_slots' => '\Evva\AirKey\Model\OfficeModeSlot[]',
        'assigned_areas' => '\Evva\AirKey\Model\AssignedArea[]',
        'active_shares' => '\Evva\AirKey\Model\ActiveShare[]',
        'sharing_codes' => '\Evva\AirKey\Model\SharingCode[]'
    ];
     ...
     *
     * @return \Evva\AirKey\Model\AnonymizeEventLog
     */
     ...
     *
     * @param \Evva\AirKey\Model\AnonymizeEventLog $anonymize_event_log Determines whether your own lock protocol entries should be anonymized. Anonymization removes references to used media and associated persons.
     *
     * @return $this
     */
     ...
     *
     * @return \Evva\AirKey\Model\OfficeModeSlot[]
     */
     ...
     *
     * @param \Evva\AirKey\Model\OfficeModeSlot[] $office_mode_slots List of office mode slots. Allows a lock to enter/leave the office mode automatically at a specific time. Only in effect if automaticOfficeModeEnabled is set to true and the lock has been synchronized.
     *
     * @return $this
     */
     ...
     * Sets assigned_areas
     *
     * @param \Evva\AirKey\Model\AssignedArea[] $assigned_areas List of assigned areas
     *
     * @return $this
     */
     ...
     * Sets active_shares
     *
     * @param \Evva\AirKey\Model\ActiveShare[] $active_shares List of shares of the locking component for other AirKey systems
     *
     * @return $this
     */
     ...
     * Sets sharing_codes
     *
     * @param \Evva\AirKey\Model\SharingCode[] $sharing_codes List of sharing codes for a locking component
     *
     * @return $this
     */
