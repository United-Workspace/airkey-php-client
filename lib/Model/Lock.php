...
class Lock implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'lock_door' => '\Evva\AirKey\Model\LockDoor',
        'lock_firmware' => '\Evva\AirKey\Model\LockFirmware',
        'comment' => 'string'
    ];
     ...
     * Gets lock_door
     *
     * @return \Evva\AirKey\Model\LockDoor
     */
     ...
     * Sets lock_door
     *
     * @param \Evva\AirKey\Model\LockDoor $lock_door Door information associated with the lock
     *
     * @return $this
     */
     ...
     * Gets lock_firmware
     *
     * @return \Evva\AirKey\Model\LockFirmware
     */
     ...
     * Sets lock_firmware
     *
     * @param \Evva\AirKey\Model\LockFirmware $lock_firmware Current firmware of the lock
     *
     * @return $this
     */
