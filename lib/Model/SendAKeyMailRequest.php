...
class SendAKeyMailRequest implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'person' => '\Evva\AirKey\Model\PersonCreateMail',
     ...
     * Gets person
     *
     * @return \Evva\AirKey\Model\PersonCreateMail
     */
     ...
     * Sets person
     *
     * @param \Evva\AirKey\Model\PersonCreateMail $person Person to create / use (the search filter criteria of a person use: 'firstName', 'lastName', and 'secondaryIdentification')
     *
     * @return $this
     */
