...
class LockProtocolEvent implements ModelInterface, ArrayAccess
{
    ...
    const TYPE_CYLINDER_SYNCHRONIZATION_VIA_OTA_AFTER_UNLOCK_PARTIAL = 'CYLINDER_SYNCHRONIZATION_VIA_OTA_AFTER_UNLOCK_PARTIAL';
    ...
    public function getTypeAllowableValues()
    {
        return [
            ...
            self::TYPE_CYLINDER_SYNCHRONIZATION_VIA_OTA_AFTER_UNLOCK_PARTIAL,
