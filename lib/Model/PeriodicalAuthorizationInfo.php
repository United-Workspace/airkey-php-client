...
class PeriodicalAuthorizationInfo extends AuthorizationInfo 
{
    ...
    protected static $swaggerTypes = [
        'type' => 'string',
        'periodical_periods' => '\Evva\AirKey\Model\PeriodicalPeriod[]',
     ...
     *
     * @return \Evva\AirKey\Model\PeriodicalPeriod[]
     */
     ...
     *
     * @param \Evva\AirKey\Model\PeriodicalPeriod[] $periodical_periods List of periodical periods in which the medium is authorized for a lock or area (max. 28 entries - 4 per week day)
     *
     * @return $this
     */
